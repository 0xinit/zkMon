...
const PickPokemon = ({}) => {
  const pokemons = [
    ...
    },
    {
      ...
      Type: "Stone",
      url: "",
      ipfs_uri: "../assets/pokemon/stone.jpeg",
    },
    {
      id: 4,
      name: "VulPix",
      ...
      DS: 100,
      Type: "fire",
      url: "../assets/pokemon/electric.jpeg",
      ipfs_uri: "",
    },
    {
      id: 5,
        ...
        <div className="h-full w-full grid md:grid-cols-4 gap-6 my-6 md:px-16">
          {pokemons.map((pokemon) => (
            ...
            >
              <div className="flex">
                <img
                  src={pokemon.url} // Use the url property as the source
                  alt="logo"
