    ...
    <div className="w-full bg-[#fff]">
      <div className="p-9 h-full">
        ...
        <div className="h-full w-full grid md:grid-cols-4 gap-6 my-6 md:px-16">
          <div
            key=""
            className="md:w-300 p-8 min-w-260 bg-darkCard backdrop-blur-md rounded-3xl flex flex-col justify-center drop-shadow-lg gap-4 hover:scale-105 transition-all duration-300"
          >
